/**
 * Product component that displays information about a product.
 *
            ...
            <div className='flex flex-col gap-2 p-3 capitalize'>
                <div className='flex justify-between'>
                    <div className='flex items-center gap-1'>
                        {/**
                        * Renders filled and empty star icons based on the product review rating,
                        * to visualize the rating as a 5 star scale.
                        */}
